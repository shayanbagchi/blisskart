...
function SearchHero() {
  return (
    <div className="flex mx-4 xs:mx-6 md:mx-10 lg:mx-16 sm:my-2 md:my-4 mb-2 bg-[url('/src/assets/sm_hero_img.webp')] bg-cover rounded-2xl"> {/*lg:bg-gradient-to-r from-magic to-transparent*/}
      <div className="flex flex-col justify-center w-full mx-6 md:mx-0 md:ml-12 my-6 md:my-10 lg:my-14 xl:my-20">
