...
import { fetchUserData, removeFromWishlist } from "../../utils/firebase.util.js";
...
function Wishlist({ userData, setUserData, products }) {
  ...
  useEffect(() => {
    if(userData){
      setWishlistedProducts(products.filter((product) => userData.wishlist.includes(product.id)));
    }
  }, [products, userData])
      ...
      <div className="">
        {userData ? (
          userData.wishlist.length !== 0 ? (
            <div className="flex flex-wrap mx-4 xs:mx-6 md:mx-10 lg:mx-16 sm:my-2 md:my-4 mb-2">
