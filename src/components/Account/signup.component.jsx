  ...
  return (
    <form onSubmit={handleSubmit} className="w-full h-full rounded-2xl pt-12">
      <div className="flex flex-col justify-center items-center pb-6">
        <p className="text-center text-3xl text-neutral-700 font-bold">Sign Up</p>
      ...
      <div className="mx-8 mb-5">
        <label className="inline-flex items-center">
          ...
          <span className="ml-2 text-sm text-neutral-700">
            I agree to the <a href="https://blisskart.in/" className="font-medium hover:underline hover:underline-offset-2">terms and conditions</a>
          </span>
        </label>
      </div>
