...
const Catagories = () => {
  ...
  return (
    <div>
      <div className="my-2 mx-4 pl-1 xs:mx-6 md:mx-10 lg:mx-16">
      ...
      <div className="flex flex-col md:flex-row justify-between mx-4 xs:mx-6 md:mx-10 lg:mx-16 my-2 md:my-4">
