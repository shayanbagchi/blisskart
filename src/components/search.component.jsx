...
function SearchHero() {
  return (
    <div className="flex mx-4 xs:mx-6 md:mx-16 lg:mx-24 sm:mt-4 bg-[url('/src/assets/sm_hero_img.png')] bg-cover rounded-2xl"> {/*lg:bg-gradient-to-r from-magic to-transparent*/}
