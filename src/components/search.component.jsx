...
function SearchHero() {
  return (
    <div className="flex mx-8 md:mx-16 lg:mx-24 md:mt-4 bg-[url('/src/assets/sm_hero_img.png')] bg-cover lg:bg-gradient-to-r from-magic to-transparent rounded-2xl">
